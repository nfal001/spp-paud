        ...
        <div class="modal-dialog modal-dialog-centered"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if ($selectedSiswaId)
                        Apakah anda yakin ingin menghapus data siswa <b>{{ $this->siswa->nama }}</b> ini?
                    @else
                        <div class="text-center">
                            <div class="spinner-border spinner-border-sm me-2" wire:loading
                                wire:target='selectedSiswaId'></div>
                ...
                <div class="modal-footer">
                    @if ($selectedSiswaId)
                        ...
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" wire:click='delete({{ $this->siswa->id }})'>Hapus</button>
                    @endif
                </div>
            </div>
        </div>
